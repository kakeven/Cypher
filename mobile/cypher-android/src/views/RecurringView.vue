...
@media (max-width: 640px) {
  ...
  .summary span { min-width: 0; padding: 10px; }
  .occurrence-list { display: grid; gap: 0; border: 0; border-radius: 0; overflow: visible; }
  .occurrence-list li { grid-template-columns: minmax(0, 1fr) auto; gap: 5px 10px; padding: 13px 12px; border: 1px solid var(--color-border); border-radius: 10px; }
  .occurrence-list li + li { margin-top: 8px; }
  .occurrence-list time { grid-column: 1 / -1; }
  .occurrence-list li > div { min-width: 0; }
  .occurrence-list li > div b { overflow-wrap: anywhere; }
  .occurrence-list li > strong { text-align: right; }
  .occurrence-list li > .button, .occurrence-list li > .future { grid-column: 1 / -1; }
  .occurrence-list li > .button { width: 100%; margin-top: 5px; }
}
</style>
